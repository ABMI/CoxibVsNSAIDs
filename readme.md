...
2. In 'R', use the following code to install the CoxibVsNSAIDs package:
...
License
=======
The CoxibVsNSAIDs package is licensed under Apache License 2.0


Development
===========
CoxibVsNSAIDs was developed in ATLAS and R Studio.
