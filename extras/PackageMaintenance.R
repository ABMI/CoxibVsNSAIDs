...
OhdsiRTools::checkUsagePackage("CoxibVsNSAIDs")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CoxibVsNSAIDs.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CoxibVsNSAIDs.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CoxibVsNSAIDs")
